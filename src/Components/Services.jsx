    ...
    return (
     <div className="bg-service-bg h- bg-opacity-20 flex-col flex-wrap">
       ...
       <div className="flex justify-evenly flex-wrap gap-8 m-8">
        <div className="text-black w-60 h-60 flex-col justify-center items-center border-2 bg-white rounded-xl hover:text-blue-500">
        ...
        <div className="text-black w-60 h-60  border-2 bg-white rounded-xl hover:text-blue-500">
         <div className="justify-center items-center flex m-2"><img src={tutorial}/></div>
