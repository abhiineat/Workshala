    ...
    <>
      ...
      <div className='flex flex-wrap flex-col mt-[4rem]'>
        ...
        <div className='flex flex-wrap flex-col '>
            ...
            <div className="flex border border-black rounded-md w-[26rem] ml-[3.5rem] max-[640px]:w-[65vw] max-[500px]:ml-8 max-[390px]:w-[62vw]">
            <input type={password? "password" : "text"} required onChange={handleChange} value={inputData.password} name="password" className="focus:border-none focus:outline-none font-WorkSans text-base w-[24rem]  h-[2.5rem] pl-3 max-[640px]:w-[65vw] max-[500px]:ml-8" placeholder='Enter Your Password' />
